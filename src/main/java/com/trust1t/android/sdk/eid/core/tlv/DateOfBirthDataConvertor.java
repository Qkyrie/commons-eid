...
public class DateOfBirthDataConvertor implements
	...
	public GregorianCalendar convert(final byte[] value)
		...
		try {
			...
			/*
			 * First try to detect the German format as there are cases in which
			 * a German format contains both dots and spaces.
			 */
			...
			if (dateOfBirthStr.length() == 4) {
				 ...
				 */
				return new GregorianCalendar(Integer.parseInt(dateOfBirthStr),
						0, 1);
			}
